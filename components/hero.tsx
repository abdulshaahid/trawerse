...
// --- Company Logo SVG Components (Memoized for Performance) ---

const IconGoogle = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const IconApple = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const IconMicrosoft = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const IconFigma = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
IconFigma.displayName = "IconFigma";

const IconGitHub = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const IconVercel = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const IconStripe = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const IconDiscord = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const IconX = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const IconSpotify = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const IconDropbox = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const IconTwitch = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
IconTwitch.displayName = "IconTwitch";

const IconLinear = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const IconYouTube = memo((props: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
...
const FLOATING_ICONS_CONFIG = [
  {
    Icon: IconGoogle,
    className: "top-[9%] left-[5%] md:top-[8%] md:left-[10%]",
  },
  {
    Icon: IconApple,
    className: "top-[23%] right-[7%] md:top-[12%] md:left-[28%]",
  },
  {
    Icon: IconFigma,
    className: "top-[15%] right-[30%] md:top-[12%] md:left-[48%]",
  },
  {
    Icon: IconStripe,
    className: "top-[23%] left-[5%] md:top-[14%] md:left-[68%]",
  },
  {
    Icon: IconYouTube,
  ...
  {
    Icon: IconSpotify,
    className: "bottom-[21%] right-[7%] md:top-[48%] md:left-[5%]",
  },
  {
    Icon: IconGitHub,
  ...
  {
    Icon: IconLinear,
    className: "bottom-[21%] left-[7%] md:top-[78%] md:left-[22%]",
  },
  {
    Icon: IconDropbox,
    className: "bottom-[22%] left-[42%] md:top-[70%] md:left-[57%]",
  },
  {
    Icon: IconVercel,
    className: "bottom-[10%] left-[45%] md:bottom-[12%] md:left-[38%]",
  },
  {
    Icon: IconTwitch,
    className: "bottom-[9%] right-[12%] md:bottom-[16%] md:right-[15%]",
  },
] as const;
          ...
          <div className="lg:col-span-10 text-center lg:text-left relative">
            ...
            >
              ...
              >
                ...
                <div
                  className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-black flex items-center justify-center transition-transform duration-300 group-hover:scale-110 relative overflow-hidden"
                  style={{
                    boxShadow: "inset 0 2px 4px rgba(0, 0, 0, 0.3)",
                  }}
                >
