...
const projects: Project[] = [
  ...
  },
  {
    ...
    liveUrl:
      "https://marketplace.visualstudio.com/items?itemName=muhammedrashid.stain",
    githubUrl: "Private Repository",
  ...
  },
  {
    ...
    description: "A sleek and minimal personal portfolio.",
  ...
  ({ project, onClick }: { project: Project; onClick: () => void }) => {
    ...
    return (
      ...
      >
        ...
        >
          <Card
            className="relative z-10 mx-auto w-full h-[240px] flex flex-col rounded-[28px] border-0 bg-[radial-gradient(120%_120%_at_30%_10%,#1a1a1a_0%,#0f0f10_60%,#0b0b0c_100%)] text-white shadow-[0_8px_16px_-4px_rgba(0,0,0,0.4)]"
            ...
            {(project.id === "1" || project.id === "2") && (
              <div className="absolute top-0 right-0 w-24 h-24 overflow-hidden z-20">
                ...
                <div className="absolute top-3 right-[-32px] w-32 text-center rotate-45 bg-accent shadow-lg">
                  <span className="text-black ml-2 text-[9px] font-extrabold tracking-wider py-1.5 block">
                    OUR PRODUCT
                  </span>
                </div>
                {/* Shadow underneath */}
                <div
                  className="absolute top-3 right-[-32px] w-32 rotate-45 bg-black/20 blur-sm"
                  style={{ height: "26px" }}
                ></div>
              </div>
            )}
            <CardContent
              className="p-5 sm:p-5 pt-4 sm:pt-4 flex flex-col justify-between h-full"
              style={{ overflow: "visible" }}
            >
              <motion.div
                  ...
                  >
                    {typeof project.icon === "string" ? (
                      <Image
                        ...
                        width={40}
                        height={40}
                        className={cn("h-10 w-10", project.iconColor)}
                      />
                    ) : (
                      <project.icon
                        className={cn("h-7 w-7", project.iconColor)}
                      />
                    )}
                  </motion.div>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        ...
        className="max-w-[95vw] sm:max-w-[85vw] lg:max-w-5xl xl:max-w-6xl max-h-[90vh] overflow-y-auto border-0 bg-transparent p-4 sm:p-6"
      >
        ...
        >
          <Card
            className="relative mx-auto w-full rounded-[28px] border-0 bg-[radial-gradient(ellipse_at_top_left,#1e1e1e_0%,#151515_50%,#0f0f0f_100%)] text-white shadow-2xl"
            style={{ overflow: "visible" }}
          >
            {(project.id === "1" || project.id === "2") && (
              <motion.div
              ...
              >
                ...
                <div className="absolute top-4 right-[-38px] w-40 text-center rotate-45 bg-accent shadow-xl">
                  <span className="text-black ml-3 text-[11px] font-extrabold tracking-wider py-2 block">
                    OUR PRODUCT
                  </span>
                </div>
                {/* Shadow underneath */}
                <div
                  className="absolute top-4 right-[-38px] w-40 rotate-45 bg-black/20 blur-sm"
                  style={{ height: "32px" }}
                ></div>
              </motion.div>
            )}
            <CardContent
              className="px-4 py-1 sm:px-6 py-1"
              style={{ overflow: "visible" }}
            >
                  ...
                  >
                    ...
                    {!imageLoaded && (
                      <div className="absolute inset-0 bg-gradient-to-br from-neutral-800 via-neutral-700 to-neutral-800 animate-pulse">
                        <div
                          className="absolute inset-0 bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.1),transparent)] animate-shimmer"
                          style={{
                    ...
                    <div className="relative w-full h-full rounded-xl overflow-hidden shadow-[0_20px_50px_-12px_rgba(74,222,128,0.25)]">
                      <Image
                        ...
                        quality={
                          project.id === "1" || project.id === "2" ? 85 : 75
                        }
                        loading={
                          project.id === "1" || project.id === "2"
                            ? "eager"
                      ...
                      <motion.div
                        className={cn(
                          "absolute top-3 left-3 h-12 w-12 rounded-full flex items-center justify-center shadow-lg backdrop-blur-sm",
                          project.iconBgColor || "bg-white/10"
                        )}
                      ...
                      >
                        {typeof project.icon === "string" ? (
                          ...
                          <project.icon
                            className={cn("h-6 w-6", project.iconColor)}
                          />
                        )}
                      </motion.div>
                    </div>
        ...
        <div className="relative pb-16">
          ...
          >
            ...
            <AnimatePresence initial={false} mode="popLayout">
              {showAll &&
                projects.slice(limit).map((project, index) => (
                  <motion.div
