...
export default function NewAbout() {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative backdrop-blur-2xl bg-gradient-to-br from-black/40 via-black/30 to-black/20 rounded-3xl md:rounded-[2.5rem] px-4 py-12 sm:px-10 sm:py-18 md:px-8 md:py-20 lg:px-10 lg:py-20 xl:px-10 xl:py-20 shadow-2xl shadow-black/50">
            ...
            <div className="relative z-10 space-y-6 sm:space-y-8 md:space-y-6">
              ...
              <div
                ref={descRef}
                className="space-y-6 sm:space-y-7 md:space-y-8 max-w-3xl xl:max-w-5xl mx-auto text-center"
                style={{ opacity: 0, transform: "translateY(30px)" }}
              >
                <p className="text-lg sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-foreground/90 leading-relaxed font-medium">
                  At Trawerse, we're not just developers — we're digital
                  craftsmen. We transform ideas into stunning, high-performance
                  websites that captivate users and drive results.
                </p>
                <div className="w-14 sm:w-14 md:w-16 xl:w-20 h-0.5 bg-accent/50 mx-auto rounded-full" />
                <p className="text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl text-foreground/70 leading-relaxed max-w-5xl mx-auto">
                  With years of experience and a passion for innovation, we
                  combine cutting-edge technology with beautiful design to
                  create web experiences that stand out in today's digital
                  landscape.
                </p>
              </div>
            </div>
      ...
      <div className="absolute bottom-20 md:bottom-40 lg:bottom-20 left-0 right-0 w-full px-0 overflow-visible scale-50 sm:scale-65 md:scale-100 origin-center">
        <CurvedLoop
